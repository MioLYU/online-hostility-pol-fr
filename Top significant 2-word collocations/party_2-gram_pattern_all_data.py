...
#%%
# For LFI
df = df[df['groupe_sigle'] == 'LFI']
non_abusive_L_df = df[df['pred_label'] == 'non-abusive']
abusive_L_df = df[df['pred_label'] == 'abusive']

# # For REN
# df = df[df['groupe_sigle'] == 'REN']
# non_abusive_R_df = df[df['pred_label'] == 'non-abusive']
# abusive_R_df = df[df['pred_label'] == 'abusive']


df.loc[:, 'text'] = df['text'].apply(preprocess_text_french)
non_abusive_L_df.loc[:, 'text'] = non_abusive_L_df['text'].apply(preprocess_text_french)
abusive_L_df.loc[:, 'text'] = abusive_L_df['text'].apply(preprocess_text_french)
# non_abusive_R_df.loc[:, 'text'] = non_abusive_R_df['text'].apply(preprocess_text_french)
# abusive_R_df.loc[:, 'text'] = abusive_R_df['text'].apply(preprocess_text_french)
...
print("Top significant 2-word collocations in all tweets for LFI:")
# print("Top significant 2-word collocations in all tweets for REN:")
for idx, (term, score) in enumerate(top_terms_df, 1):
    print(f"{idx}. {term}: {score}")

#%%
tfidf_non_abusive = vectorizer.fit_transform(non_abusive_L_df['text'])
# tfidf_non_abusive = vectorizer.fit_transform(non_abusive_R_df['text'])
...
print("Top significant 2-word collocations in non-abusive tweets for LFI:")
# print("Top significant 2-word collocations in non-abusive tweets for REN:")
for idx, (term, score) in enumerate(top_terms_non_abusive, 1):
    print(f"{idx}. {term}: {score}")

#%%
tfidf_abusive = vectorizer.fit_transform(abusive_L_df['text'])
# tfidf_abusive = vectorizer.fit_transform(abusive_R_df['text'])
...
print("Top significant 2-word collocations in abusive tweets for LFI:")
# print("Top significant 2-word collocations in abusive tweets for REN:")
...
plot_word_cloud(top_terms_df, "Top significant 2-word collocations in all tweets for LFI", "LFI_new_all_tweets_wordcloud.png")

plot_word_cloud(top_terms_non_abusive, "Top significant 2-word collocations in non-abusive tweets for LFI", "LFI_new_non_abusive_tweets_wordcloud.png")

plot_word_cloud(top_terms_abusive, "Top significant 2-word collocations in abusive tweets for LFI", "LFI_new_abusive_tweets_wordcloud.png")

# plot_word_cloud(top_terms_df, "Top significant 2-word collocations in all tweets for REN", "REN_new_all_tweets_wordcloud.png")

# plot_word_cloud(top_terms_non_abusive, "Top significant 2-word collocations in non-abusive tweets for REN", "REN_new_non_abusive_tweets_wordcloud.png")

# plot_word_cloud(top_terms_abusive, "Top significant 2-word collocations in abusive tweets for REN", "REN_new_abusive_tweets_wordcloud.png")