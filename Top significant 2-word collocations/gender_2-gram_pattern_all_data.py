...
# For Female 
df = df[df['sexe'] == 'F']
non_abusive_f_df = df[df['pred_label'] == 'non-abusive']
abusive_f_df = df[df['pred_label'] == 'abusive']

# #For male
# df = df[df['sexe'] == 'H']
# non_abusive_h_df = df[df['pred_label'] == 'non-abusive']
# abusive_h_df = df[df['pred_label'] == 'abusive']

df.loc[:, 'text'] = df['text'].apply(preprocess_text_french)
non_abusive_f_df.loc[:, 'text'] = non_abusive_f_df['text'].apply(preprocess_text_french)
abusive_f_df.loc[:, 'text'] = abusive_f_df['text'].apply(preprocess_text_french)
# non_abusive_h_df.loc[:, 'text'] = non_abusive_h_df['text'].apply(preprocess_text_french)
# abusive_h_df.loc[:, 'text'] = abusive_h_df['text'].apply(preprocess_text_french)
...
print("Top significant 2-word collocations in all tweets for females:")
# print("Top significant 2-word collocations in all tweets for males:")
for idx, (term, score) in enumerate(top_terms_df, 1):
    print(f"{idx}. {term}: {score}")

#%%
tfidf_non_abusive = vectorizer.fit_transform(non_abusive_f_df['text'])
# tfidf_non_abusive = vectorizer.fit_transform(non_abusive_h_df['text'])
...
print("Top significant 2-word collocations in non-abusive tweets for females:")
# print("Top significant 2-word collocations in non-abusive tweets for males:")
for idx, (term, score) in enumerate(top_terms_non_abusive, 1):
    print(f"{idx}. {term}: {score}")

#%%
tfidf_abusive = vectorizer.fit_transform(abusive_f_df['text'])
# tfidf_abusive = vectorizer.fit_transform(abusive_h_df['text'])
...
print("Top significant 2-word collocations in abusive tweets for females:")
# print("Top significant 2-word collocations in abusive tweets for males:")
...
plot_word_cloud(top_terms_df, "Top significant 2-word collocations in all tweets for females", "f_new_all_tweets_wordcloud.png")

plot_word_cloud(top_terms_non_abusive, "Top significant 2-word collocations in non-abusive tweets for females", "f_new_non_abusive_tweets_wordcloud.png")

plot_word_cloud(top_terms_abusive, "Top significant 2-word collocations in abusive tweets for females", "f_new_abusive_tweets_wordcloud.png")

# plot_word_cloud(top_terms_df, "Top significant 2-word collocations in all tweets for males", "h_new_all_tweets_wordcloud.png")

# plot_word_cloud(top_terms_non_abusive, "Top significant 2-word collocations in non-abusive tweets for males", "h_new_non_abusive_tweets_wordcloud.png")

# plot_word_cloud(top_terms_abusive, "Top significant 2-word collocations in abusive tweets for males", "h_new_abusive_tweets_wordcloud.png")